...
public class GameUI {
    ...
    public static class IntroUI {
        ...
        public static Parent createIntroUI() {
            ...
            HBox_intro_root.getStyleClass().addAll("Alignment-center", "Background-gameTheme");
            HBox_intro_root.setId("HBox-intro-root");
            ObservableList<Node> HBox_intro_root_Children = HBox_intro_root.getChildren();
            VBox VBox_intro_mainPanel = new VBox();
            VBox_intro_mainPanel.getStyleClass().add("Alignment-center");
            VBox_intro_mainPanel.setId("VBox-intro-mainPanel");
            ObservableList<Node> VBox_intro_mainPanel_Children = VBox_intro_mainPanel.getChildren();
            VBox VBox_intro_welcome = new VBox();
            VBox_intro_welcome.getStyleClass().add("Alignment-center");
            VBox_intro_welcome.setId("VBox-intro-welcome");
            ...
            VBox_config1.getStyleClass().add("Alignment-bottomCenter");
            VBox_config1.setId("VBox-intro-config1");
            ...
            HBox_config1Body.getStyleClass().add("Alignment-center");
            HBox_config1Body.setId("HBox-intro-config1Body");
            ObservableList<Node> HBox_config1Body_Children = HBox_config1Body.getChildren();
            VBox VBox_config1Labels = new VBox();
            VBox_config1Labels.getStyleClass().add("Alignment-leftCenter");
            VBox_config1Labels.setId("VBox-intro-config1Labels");
            ...
            VBox_config1Choices.getStyleClass().add("Alignment-rightCenter");
            VBox_config1Choices.setId("VBox-intro-config1Choices");
            ...
            ChoiceBox_playersNr.getStyleClass().add("ChoiceBox-gameTheme");
            ChoiceBox_playersNr.setId("ChoiceBox-intro-playersNr");
            ChoiceBox<String> ChoiceBox_mapSize = IntroUI.createMapSizeChoiceBox();
            ChoiceBox_mapSize.getStyleClass().add("ChoiceBox-gameTheme");
            ChoiceBox_mapSize.setId("ChoiceBox-intro-mapSize");
            ChoiceBox<String> ChoiceBox_resDensity = IntroUI.createResDensityChoiceBox();
            ChoiceBox_resDensity.getStyleClass().add("ChoiceBox-gameTheme");
            ChoiceBox_resDensity.setId("ChoiceBox-intro-resDensity");
            ...
            VBox_config2.getStyleClass().add("Alignment-topCenter");
            VBox_config2.setId("VBox-intro-config2");
            ...
            VBox_config2Body.getStyleClass().add("Alignment-center");
            VBox_config2Body.setId("VBox-intro-config2Body");
            ObservableList<Node> VBox_config2Body_Children = VBox_config2Body.getChildren();
            Accordion_playersSettings.getStyleClass().add("Accordion-gameTheme");
            Accordion_playersSettings.setId("Accordion-intro-playersSettings");
            ...
            HBox_buttons.getStyleClass().add("Alignment-center");
            HBox_buttons.setId("HBox-intro-buttons");
            ObservableList<Node> VBox_buttons_Children = HBox_buttons.getChildren();
            Button Button_play = new Button("PLAY");
            Button_play.getStyleClass().addAll("Button-gameTheme", "Font-size-S");
            Button_play.setId("Button-intro-play");
            Button Button_quit = new Button("QUIT");
            Button_quit.getStyleClass().addAll("Button-gameTheme", "Font-size-S");
            Button_quit.setId("Button-intro-quit");
        ...
        public static void updatePlayersSettingsAccordion(int playersNr, Accordion playersSettingsAccordion) {
            ...
            for (int i = 1; i <= playersNr; ++i) {
                ...
                TextField_playerName.getStyleClass().add("TextField-gameTheme");
                TextField_playerName.setId("TextField-intro-player" + i + "Name");
                ...
                ChoiceBox_playerColor.getStyleClass().addAll("ChoiceBox-gameTheme");
                ChoiceBox_playerColor.setId("ChoiceBox-intro-player" + i + "Color");
        ...
        public static ChoiceBox<String> createPlayerColorChoiceBox(int playerNr, ImageView img) {
            ...
            img.setImage(new javafx.scene.image.Image(iconPath));
    ...
    public static class InGameUI {
        public static Parent createInGameUI(Game g) {
            ...
            HBox_inGameRoot.getStyleClass().add("Background-gameTheme");
            HBox_inGameRoot.setId("HBox-ingame-root");
            ObservableList<Node> HBox_inGameRoot_Children = HBox_inGameRoot.getChildren();
            VBox VBox_inGameLeft = new VBox();
            VBox_inGameLeft.getStyleClass().add("Alignment-center");
            VBox_inGameLeft.setId("VBox-ingame-left");
            VBox_inGameLeft.setPrefWidth(480);
            ObservableList<Node> VBox_inGameLeft_Children = VBox_inGameLeft.getChildren();
            Accordion Accordion_playersPanels = playersAsAccordion(g.getPlayers());
            Accordion_playersPanels.setId("Accordion-ingame-playersPanels");
            TextArea TextArea_globalLog = messageLogAsTextArea(MessagingSystem.MESSAGE_LOG);
            TextArea_globalLog.setEditable(false);
            ...
            TilePane mapPane = mapAsPane(g.getMap());
            mapPane.setId("TilePane-ingame-mapPane");
        ...
        private static TilePane mapAsPane(Map map) {
            TilePane mapPane = new TilePane();
            mapPane.setPrefSize(Map.MAP_WIDTH_PX, Map.MAP_HEIGHT_PX);
